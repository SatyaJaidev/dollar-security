...
export const ClearedQueriesTable = () => {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-3 lg:p-6 h-[350px] flex flex-col">
      ...
      <div className="overflow-x-auto overflow-y-hidden">
        <div className="min-w-[600px]"> {/* Minimum width for table content */}
          {/* Fixed Header */}
